    ...
    <div className="w-full h-screen bg-gray-900">
      ...
      <div className="w-full h-[calc(100vh-4rem)] flex flex-row gap-8 p-8 bg-gradient-to-t from-gray-800 to-gray-600">
        ...
        <div className="w-full h-auto flex flex-wrap justify-center gap-8 flex-grow">
          <div className="flex flex-col items-center justify-center bg-gray-800 p-6 rounded-xl shadow-lg hover:animate-pulse">
        ...
        <div className="w-[80%] h-96 bg-gray-900 p-8 rounded-2xl shadow-xl flex flex-col items-center justify-center mt-24">

        <h1 className="text-4xl font-bold text-white p-4 text-left">Education</h1>
